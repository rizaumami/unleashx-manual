% Most are taken from: https://jdhao.github.io/2019/05/30/markdown2pdf_pandoc/

\usepackage{fancyvrb,newverbs}
\usepackage[top=2cm, bottom=1.5cm, left=2cm, right=2cm]{geometry}

% Image scaling: https://tex.stackexchange.com/a/83074
\usepackage{graphicx}
\setkeys{Gin}{width=.4\csname Gin@nat@width\endcsname,keepaspectratio}

\PassOptionsToPackage{dvipsnames,svgnames,x11names}{xcolor}
\usepackage{hyperref}

% Smaller code font size: https://stackoverflow.com/a/27159300
%\renewenvironment{Shaded} {\begin{snugshade}\footnotesize} {\end{snugshade}}
% Syntax highlighter without background color wont work with above snugshade.
\renewenvironment{Shaded}{\footnotesize}{}

% Keep image order: https://stackoverflow.com/a/58840456
\usepackage{float}
...
% we need to combine this with `-V subparagraph` when invoking pandoc
\usepackage{titlesec}
